...
setup(
    ...
    version='0.1.0',
    license='MIT license',
    description='A new pipeline, mirTime, that predicts microRNA targets by integrating sequence features and time-series expression profiles in a specific experimental condition.',
    long_description='%s\n%s' % (
